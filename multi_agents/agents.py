...
{{
  ...
  "patient_location": "Extract location if mentioned, or 'Unknown Location'"
    ...
    try:
        location_url = "https://GPS-backend.vercel.app/device_location"
    ...
    try:
        backend_url = "https://GPS-backend.vercel.app/emergency_detected"
...
"""
    ...
    try:
        ...
        try:
            backend_url = "https://GPS-backend.vercel.app/medical_record"
            headers = {"Content-Type": "application/json"}
