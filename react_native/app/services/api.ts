// API Service for GPS Multi-Agent and Backend Integration

const MULTI_AGENT_BASE_URL = 'https://GPS-multi-agent.vercel.app';
const BACKEND_BASE_URL = 'https://GPS-backend.vercel.app';
